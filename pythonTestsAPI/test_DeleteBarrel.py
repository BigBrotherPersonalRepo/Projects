...
def test_delete_barrel(set_up):
   ...
   common.is_format_valid(response, 201, "test_delete_barrel")
   ...
   common.verify_status(delete, 204, "test_delete_barrel")
   ...
   common.verify_status_negative(barrelGetResponse, 200, "test_delete_barrel")