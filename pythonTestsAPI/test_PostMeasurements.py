...
def test_post_measurement(set_up):
    ...
    common.is_format_valid(barrelResponse, 201, "test_post_measurement")
    ...
    for measurement in measurements["inputsValid"]:
        ...
        common.is_format_valid(measurementResponse, 201, "test_post_measurement")
    ...
    for measurement in measurements["inputsInvalid"]:
        ...
        common.verify_status_negative(responseInvalid, 201, "test_post_measurement")
