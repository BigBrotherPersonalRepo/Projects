...
def test_post_barrels(set_up):
    ...
    for barrel in barrels["inputsValid"]:
        ...
        common.is_format_valid(response, 201, "test_post_barrels")
        ...
        common.verify_status(delete, 204, "test_post_barrels") #***
    ...
    for barrel in barrels["inputsInvalid"]:
        ...
        if (responseInvalid.status_code == 201):
            ...
            common.verify_status(deleteInvalid, 204, "test_post_barrels")

        #overeni, zda api odmitla nevalidni data (krok 3.c)
        common.verify_status_negative(responseInvalid, 201, "test_post_barrels") #***