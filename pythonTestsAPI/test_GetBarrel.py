...
def test_get_barrel(set_up):
    ...
    common.is_format_valid(barrelPostResponse, 201, "test_get_barrel")
    ...
    common.is_format_valid(barrelGetResponse, 200, "test_get_barrel")
    ...
    common.verify_status(delete, 204, "test_get_barrel") #***
