...
def test_get_measurement(set_up):
    ...
    common.is_format_valid(barrelPostResponse, 201, "test_get_measurement")
    ...
    common.is_format_valid(measurementPostResponse, 201, "test_get_measurement")
    ...
    common.is_format_valid(measurementGetResponse, 201, "test_get_measurement")
    ...
    common.verify_status(deleteBarrel, 204, "test_get_measurement")
    ...
    common.verify_status_negative(measurementInvalidGetResponse, 200, "test_get_measurement")