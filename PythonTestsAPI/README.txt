...
Sdílená custom knihovna pro sadu je soubor "common.py". Program dale pouziva knihovnu requests. 
...
Scripty jsou spustitelne standartne prikazem "python {nazev_scriptu}". Take by meli byt spustitelne standartnimi frameworky pro praci s technologii python.
